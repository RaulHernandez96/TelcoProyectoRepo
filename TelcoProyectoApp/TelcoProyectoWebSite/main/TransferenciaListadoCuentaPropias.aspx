<%@ Page Title="" Language="C#" MasterPageFile="~/main/MainLayout.master" AutoEventWireup="true" CodeFile="TransferenciaListadoCuentaPropias.aspx.cs" Inherits="main_TransferenciaListadoCuentaPropias" %>

<asp:Content ID="_cMainContent" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <%-- Encabezado --%>
  <section class="content-header">
    <h1>Listado de cuentas para transferencias propias</h1>
