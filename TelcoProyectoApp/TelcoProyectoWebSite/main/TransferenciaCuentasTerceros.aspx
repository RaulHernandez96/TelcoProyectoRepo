<%@ Page Title="" Language="C#" MasterPageFile="~/main/MainLayout.master" AutoEventWireup="true" CodeFile="TransferenciaCuentasTerceros.aspx.cs" Inherits="main_TransferenciaCuentasTerceros" %>
                          ...
                          <div class="box box-warning">
                            ...
                            <div class="box-body">
                              ...
                              <div class="row">
                                ...
                                <div class="col-xs-8">
                                  <asp:TextBox ID="_lbCuentaDestino" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-xs-12 col-lg-8 col-lg-offset-4">
                                  <asp:RequiredFieldValidator ID="_rfvCuentaDestino" ControlToValidate="_lbCuentaDestino" 
